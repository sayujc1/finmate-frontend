...
// import {resetEditState} from "../../actions/IncomeManagementAction";
// const { Option } = Select;

// const EditForm = ({ addForm, setAddForm, reducer,formType,setModal }) => {
//   // set addFormData from reducer
  
//   // const userDetails = useSelector(state => state.UserReducer.userDetails);
//   const commonReducer = useSelector(state => state.IncomeReducer);
//   console.log("Common reducer", commonReducer.editData, commonReducer.isEdit)
//   const dispatch = useDispatch();
//   const [loading, setLoading] = useState(false);
//   const [AddFormErrors, setAddFormErrors] = useState({});
//     const categoryList = formType==="Income"?INCOME_CATEGORY:formType==="Expense"?EXPENSE_CATEGORY:SAVINGS_CATEGORY;
//   // let [addForm,setAddForm] = useState(commonReducer.editData);
//   console.log("addForm", addForm,AddFormErrors)
...
//         // isEdit?
//         await UpdateForm(reducer,commonReducer.editData, addForm,formType,dispatch)
//           .then(response => {
//             notification.success({
//               message: "Updated "+formType,
//             });
//             handleReset();
...
//           <Card title={!isEdit&&<div style={{textAlign: "center"}}>Add {`${formType}`}</div>} bordered={false} style={{borderRadius: "20px", backgroundColor: "transparent", width: "100%"}}>
//             <>
...
//                     loading={loading}
//                   >
//                     {loading ? <>Saving ...</> : <>{`${isEdit?'Edit':'Add'}`} {`${formType}`}</>}
//                   </Button>
//                 </Popconfirm>
//                 <Popconfirm

    ...
    <>
      <div className="ExpenseDetailsContainer">
        ...
        >
          ...
          >
            <span style={{ fontSize: "1.4rem", fontWeight: 500 }}>Total Expense&nbsp;:&nbsp;</span>{" "}
      ...
      >
        ...
        >
          <AddForm reducer={expenseDetails}  formType={'Expense'} addForm={addForm} setAddForm={setAddForm} AddFormErrors={AddFormErrors} setAddFormErrors={setAddFormErrors}/>
        </Col>
        {/* display Expense */}
        <Col
          xs={{ span: 24 }}
